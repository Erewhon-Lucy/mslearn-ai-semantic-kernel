...
async def main():
    ...
    # Create a semantic kernel prompt templateWW
    ...
    sk_rendered_promt = await sk_prompt_template.render(
        kernel,
        KernelArguments(
    ...
    chat_history.add_user_message(sk_rendered_promt)
    await get_reply() 
    ...
    print("Assistant > How can I help you further?")
